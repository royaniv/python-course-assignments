...
# This program calculates the final amount (N) after a certain time (t) given an initial amount (N0) and a growth rate (r) using the formula:
# N = N0 * e^(r * t)
...
if __name__ == "__main__":    final_amount = expgrowth()
